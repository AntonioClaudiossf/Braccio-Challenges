...
def callbackAruco(msg):    
    for i in range(0, len(msg.markers)):
        ...
        print("mad",msg.markers[i])
        #print(" roll = ", msg.markers[i].pose.pose.position.x)
        #print(" pitch = ", msg.markers[i].pose.pose.position.y)
        #print(" yaw = ", msg.markers[i].pose.pose.position.z)
